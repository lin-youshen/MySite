...
根据视觉对跑道进行语义分割，以自动引导固定翼飞机保持横向姿态。(2024)
...
<div style="display: flex; align-items: center; margin-top: 0px; justify-content: flex-end;" class="sidebar-logo">
  <img src="../../media/controller.gif" alt="Logo" width="480" height="150" style="text-align: right; margin-right: 1px;">
  <img src="../../media/se3controller.png" alt="Logo" width="410" height="100" style="text-align: right; margin-right: 1px;">
</div>
